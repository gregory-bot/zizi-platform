  ...
  return (
    <div className="relative" onMouseLeave={() => setIsOpen(false)}>
      ...
      {dropdown.length > 0 && isOpen && (
        <div className="absolute z-10 left-0 mt-2 w-48 origin-top-left rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md' : 'bg-transparent'}`}>
      ...
      {/* Mobile menu */}
      <div className={`md:hidden ${mobileMenuOpen ? 'fixed inset-0 bg-black bg-opacity-50' : 'hidden'}`}>
